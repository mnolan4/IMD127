...
Organize your code better and create reusable components. Creative Challenge 2 is the interactive drawing tool (arrays and interaction).
...
Homework Sketches (Weeks 1, 2, 4, 5, 6, 8, 9, 10, 12)
...
• Creative Challenge 2: Interactive Drawing Tool (Week 7) - Arrays, mouse/keyboard, and persistent marks
...
Remember: These strategies are tools to help you learn. Find what works for you and adapt as needed. You've got this!`
        ...
        },
        {
            ...
            topics: ["For loops", "While loops", "Nested loops", "Basic randomness", "Pattern generation", "Modulo operator"],
            ...
            tasks: {
                ...
                examples: [
                    ...
                    { title: "While Loops", file: "code-examples/week-04-loops/while-loops-grid.js", type: "code", description: "Review this example to use while loops as an alternative to for loops. See how a condition acts as a gatekeeper: the loop runs while the condition is true. Nested while loops create a grid of circles, with manual initialization and update of position variables.", embedDemo: true },
        ...
        },
        {
            ...
            deliverables: ["Code tracing (object interactions)", "Creative Challenge 2: Interactive Drawing Tool"],
            ...
            schedule: {
                ...
                assignments: {
                    "creative-challenge-02": "2026-04-13T23:59:00"
                },
                assessments: {
                ...
                activities: {
                    ...
                    "2026-03-12": { type: "lab", topics: ["Object interactions", "Creative Challenge 2: Interactive Drawing Tool", "Spring Break preparation"] }
                }
            },
            tasks: {
        ...
        },
        {
            ...
            schedule: {
                ...
                assignments: {
                    "homework-sketch-08": "2026-04-06T23:59:00"
                },
                assessments: {},
                activities: {
