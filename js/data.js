...
1. Set up your p5.js account (check the p5.js Setup Guide in the Getting Started section)
...
Matt`
                    ...
                    { 
                        title: "p5.js Setup Guide", 
                        file: "pdfs/Student-Resources/Setup-Guides/p5js-Editor-Setup.pdf",
                        content: `Overview
The p5.js web editor is a browser-based code editor that lets you write and run p5.js sketches without installing anything. It is perfect for getting started with creative coding.
...
• Left panel: File browser for your sketches, examples library, and reference documentation
• Center panel: Code editor where you write code, line numbers, and syntax highlighting
• Right panel: Preview window where your sketch runs and a console for debugging
• Top bar: Play button to run your sketch, stop button to stop your sketch, settings, and an account menu

Step 3: Create Your First Sketch
• Click File, then New, or use the plus icon
• You will see a basic template with setup() and draw() functions
• Click the Play button to run your sketch
• You should see a gray canvas in the preview window

Step 4: Try a Simple Example
Replace the code in the editor with code that includes setup(), draw(), background(), and ellipse() functions using mouseX and mouseY. Click Play and move your mouse over the canvas. You should see a circle following your mouse.

Step 5: Save Your Sketch
• Click File, then Save, or press Cmd or Ctrl + S
• Give your sketch a name
• Your sketch is now saved in your account

Step 6: Share Your Sketch
Click File, then Share. Choose sharing options:
• You can get a shareable link
• You can get code to embed on a website
• You can share to OpenProcessing, which we will set up separately

Tips and Tricks

Keyboard Shortcuts
• Cmd or Ctrl + Enter to play
• Cmd or Ctrl + S to save
• Cmd or Ctrl + N to create a new file
• Cmd or Ctrl + / to comment or uncomment
...
• Font Size (current size indicator)
• Increase (larger font)

Editor Options:
• Autosave: On/Off - Automatically saves your work
• Autoclose Brackets and Quotes: On/Off - Automatically closes brackets, parentheses, and quotes
• Autocomplete Hinter: On/Off - Shows code completion hints
• Word Wrap: On/Off - Wraps long lines to fit the editor width

Accessibility Options:
• Line numbers: On/Off - Shows line numbers in the editor
• Lint warning sound: On/Off - Plays sound when code has errors
• Preview sound: On/Off - Plays sound in preview
• Accessible text-based canvas: Used with screen reader
• Plain-text: Text-based representation of canvas
• Table-text: Table-based representation of canvas

Library Management:
• p5.sound.js Add-on Library: On/Off toggle
• p5.js 1.x Compatibility Add-on Libraries: Various compatibility options

Examples Library
Click Examples in the left panel to browse:
• Basic examples
• Advanced examples
• Tutorial examples
• Community examples
...
Click Reference in the left panel to access:
• Complete p5.js documentation
• Function reference
...
For p5.js add-on libraries like p5.sound:
1. Click Settings (gear icon) in the top bar
2. Find "p5.sound.js Add-on Library" in the settings panel
3. Toggle it On
4. The library is now available in your sketch
5. You can also toggle "p5.js 1.x Compatibility Add-on Library" options if needed

For advanced external libraries like ml5.js:
Advanced libraries like ml5.js are not available as toggles and require adding script tags in HTML mode:
1. Click the file name at the top of the editor
2. Select HTML from the dropdown to switch to HTML mode
3. Add the script tag in the <head> section, before the p5.js scripts:

<head>
<!-- Advanced library - must be before p5.js -->
<script src="https://unpkg.com/ml5@latest/dist/ml5.min.js"></script>
<!-- p5.js scripts (version 1.11.11) -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.11.11/p5.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.11.11/addons/p5.sound.min.js"></script>
</head>

Important: Advanced libraries must be loaded before p5.js scripts. The order matters! Similarly, other advanced libraries require similar loading in HTML mode.

HTML Mode
Switch to HTML mode for more control and to add advanced libraries:
1. Click the file name at the top
2. Select HTML from the dropdown
3. You can now edit HTML, CSS, and JavaScript separately
4. Required for advanced libraries like ml5.js that need script tags in the HTML

When you switch to HTML mode, you'll see the full HTML structure. Your JavaScript code goes in sketch.js, and you can add script tags in the <head> section for external libraries.

File Management
Organize your sketches:
• Create folders by project or week
• Use descriptive names for sketches
• Archive old sketches you're not using
• Keep a "practice" folder for experiments

Collaboration
Share sketches for collaboration:
1. Click File, then Share
2. Copy the shareable link
3. Send to collaborators
4. They can view and fork your sketch
5. Use comments to discuss code
...
• Check the console (bottom right) for error messages
• Verify your code has both setup() and draw() functions
...
Possible causes:
• Missing createCanvas() function
• draw() function doesn't exist
• Shapes are drawn off-screen
• Colors match background
• Code has errors preventing execution

Solutions:
• Add createCanvas(400, 400) in setup()
• Make sure draw() function exists
• Check shape coordinates are within canvas bounds
...
• Check if browser is blocking the site
• Try a different browser

If still not working:
• Copy your code to a text file as backup
...
Code Looks Wrong
Check for:
• Typos in function names (e.g., ellips instead of ellipse)
• Unbalanced brackets or parentheses
• Missing commas in function parameters
• Wrong parameter order (check reference)
• Case sensitivity (JavaScript is case-sensitive)

Solutions:
• Use the reference documentation to check function names
...
• Reduce number of shapes drawn per frame
• Optimize calculations in draw()
• Use noLoop() if animation isn't needed
• Check browser console for warnings

Library Not Working
If added library doesn't work:
• Make sure library was added correctly in Settings
• Check library documentation for correct usage
• Verify you're using the right function names
• Check console for library-specific errors
...
• Download sketches as backup (File > Download)
• Keep local copies of important code

Recovery:
• Check if auto-save captured your work
• Look in your sketch list for previous versions
• Check browser history for cached versions
• Contact instructor if work is lost

Next Steps
• Create your account
• Create your first sketch
• Try the example code
• Save and share a sketch
• Explore the examples library
• Read the reference documentation

Additional Resources
• The p5.js website is at https://p5js.org/
• The p5.js reference is at https://p5js.org/reference/
• The p5.js examples are at https://p5js.org/examples/
• The getting started tutorial is at https://p5js.org/get-started/

Questions?
Check the troubleshooting section above. Review FAQs in the Student-Resources/FAQs/ folder. Contact the instructor. Ask during class. Happy coding!`
                    },
                    { 
