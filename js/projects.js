...
// Displays major creative projects (Creative Challenges 2–3, Final Portfolio, etc.)
...
function loadProjectsPage() {
    ...
    // Get all major projects (Major Project 1, Creative Challenges 2–3, Final Portfolio)
    const majorProjects = [];
