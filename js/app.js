...
// #region agent log
try {
    fetch('http://127.0.0.1:7821/ingest/845bb830-8cd9-4e24-8f16-a569dc5ba208',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b32370'},body:JSON.stringify({sessionId:'b32370',location:'app.js:parse',message:'app.js executed',data:{hasCourseData:typeof courseData!=='undefined'},timestamp:Date.now(),hypothesisId:'H2',runId:'pre-fix'})}).catch(()=>{});
} catch (e) {}
// #endregion
...
function initializeApp() {
    // #region agent log
    try {
        const wks = typeof getAllWeeks === 'function' ? getAllWeeks() : null;
        fetch('http://127.0.0.1:7821/ingest/845bb830-8cd9-4e24-8f16-a569dc5ba208',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b32370'},body:JSON.stringify({sessionId:'b32370',location:'app.js:initializeApp',message:'init',data:{weeksLen:wks?wks.length:null},timestamp:Date.now(),hypothesisId:'H2',runId:'pre-fix'})}).catch(()=>{});
    } catch (e) {
        fetch('http://127.0.0.1:7821/ingest/845bb830-8cd9-4e24-8f16-a569dc5ba208',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b32370'},body:JSON.stringify({sessionId:'b32370',location:'app.js:initializeApp',message:'init getAllWeeks threw',data:{err:String(e&&e.message)},timestamp:Date.now(),hypothesisId:'H2',runId:'pre-fix'})}).catch(()=>{});
    }
    // #endregion
...
function loadPageContent() {
    ...
    if (filename === 'index.html' || filename === '' || filename === 'Website/' || !filename) {
        ...
        // #region agent log
        fetch('http://127.0.0.1:7821/ingest/845bb830-8cd9-4e24-8f16-a569dc5ba208',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b32370'},body:JSON.stringify({sessionId:'b32370',location:'app.js:loadPageContent',message:'week route',data:{filename,pathname:window.location.pathname,hrefTail:window.location.href.slice(-48),weekMatch:weekMatch?weekMatch[1]:null},timestamp:Date.now(),hypothesisId:'H5',runId:'pre-fix'})}).catch(()=>{});
        // #endregion
        if (weekMatch) {
...
function loadWeekPage(weekNumber) {
    ...
    // #region agent log
    fetch('http://127.0.0.1:7821/ingest/845bb830-8cd9-4e24-8f16-a569dc5ba208',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b32370'},body:JSON.stringify({sessionId:'b32370',location:'app.js:loadWeekPage:entry',message:'loadWeekPage',data:{weekNumber,weekId:week.id,hasTopics:Array.isArray(week.topics),hasTasks:!!week.tasks},timestamp:Date.now(),hypothesisId:'H3-H4',runId:'pre-fix'})}).catch(()=>{});
    // #endregion
    ...
    // #region agent log
    fetch('http://127.0.0.1:7821/ingest/845bb830-8cd9-4e24-8f16-a569dc5ba208',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b32370'},body:JSON.stringify({sessionId:'b32370',location:'app.js:loadWeekPage:success',message:'innerHTML set',data:{weekNumber,weekId:week.id,htmlLen:html.length},timestamp:Date.now(),hypothesisId:'H1',runId:'pre-fix'})}).catch(()=>{});
    // #endregion
    ...
    setTimeout(() => {
        ...
        // #region agent log
        fetch('http://127.0.0.1:7821/ingest/845bb830-8cd9-4e24-8f16-a569dc5ba208',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b32370'},body:JSON.stringify({sessionId:'b32370',location:'app.js:loadWeekPage:catch',message:'loadWeekPage threw',data:{weekNumber,err:String(err&&err.message),stack:String(err&&err.stack).slice(0,500)},timestamp:Date.now(),hypothesisId:'H1',runId:'pre-fix'})}).catch(()=>{});
        // #endregion
    }
}
